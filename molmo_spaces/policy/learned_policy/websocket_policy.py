...
# forever. pi0/pi0.5, the consumers of this path, measure well under a second per inference.
...
class WebsocketPolicy(InferencePolicy):
    ...
    def inference_model(self, model_input):
        ...
        # pi0/pi0.5, well under a second per inference, so 600s is far above any real call and
        # only fires when the server has genuinely stopped responding.
